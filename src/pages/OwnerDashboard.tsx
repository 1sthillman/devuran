  ...
  export function OwnerDashboard() {
          ...
          <div className="min-h-[60vh] flex items-center justify-center px-4">
            ...
            >
              ...
              <motion.div
                ...
                className="mb-6"
              >
                {/* ✅ BIR KULLANICI SADECE 1 İŞLETME OLUŞTURABİLİR */}
                {salon ? (
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[var(--muted-lead)] mb-4">
                          Bir kullanıcı sadece bir işletme oluşturabilir. Mevcut işletmenizi "Ayarlar" sekmesinden düzenleyebilirsiniz.
                        </p>
                        <button
                          onClick={() => setActiveTab('settings')}
                          className="px-4 py-2 rounded-xl bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 text-blue-300 font-semibold text-sm transition-all active:scale-95 flex items-center gap-2"
                        >
                          <Settings size={16} />
              ...
              >
                {salon 
                  ? 'İşletme bilgilerinizi "Ayarlar" sekmesinden görüntüleyebilir ve düzenleyebilirsiniz.'
    ...
    return (
      <>
      {/* ✅ SINGLE MODAL ZONE - Tüm full-screen modallar burada (üst üste binmeyi engeller) */}
      
      {/* Legacy Business Migration Modal - wizard ile çakışmayı engelle */}
      ...
      {/* Salon Setup/Edit Modal - TEK INSTANCE */}
