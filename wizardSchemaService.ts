 ...
 *
 * NOT: `db` import'unu kendi firebase.ts dosyanızdaki init'e göre düzenleyin.
 * Aşağıda projenizdeki `firebaseService.ts` ile aynı importları varsaydım.
 */
...
import { db } from '@/lib/firebase'; // Projenizdeki mevcut firebase init dosyası
